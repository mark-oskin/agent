...
MCP_REPL_HELP = (
    ...
    "Servers are only started after /mcp enable (adding or editing prefs does not enable MCP).\n\n"
    "Commands:\n"
    "  /mcp help              Show this text\n"
    "  /mcp list              Show mcp_enabled + configured servers (JSON)\n"
    "  /mcp status            Same as list, plus last connect errors and discovered tool count\n"
    "  /mcp enable | disable  Turn MCP tool merging on/off\n"
