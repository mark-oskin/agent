...
SYSTEM_INSTRUCTIONS = (
    ...
    "- If the user request requires interacting with external systems and an appropriate allowed tool exists, do not refuse "
    "by claiming you lack access; use the tool. If a tool call fails, report the tool output and try a corrected call.\n\n"
