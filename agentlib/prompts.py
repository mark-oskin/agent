...
NATIVE_SYSTEM_INSTRUCTIONS = (
    ...
    "\n"
    "- session_command can run most /commands the user could type (/set, /show, /help, /usage, /clear, /cd, …). "
    "It cannot run /quit, /while, /skill, /send, /fork, /call_python, /run_command, or /set lock.\n"
    "\n"
